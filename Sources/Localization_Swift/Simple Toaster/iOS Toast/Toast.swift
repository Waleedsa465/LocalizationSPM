...
public class Toast {
    @MainActor private static var activeToasts = [Toast]()
    ...
    @MainActor private func closeOverlappedToasts() {
    ...
    @MainActor private func createBackgroundView() -> UIView? {
...
public extension Toast {
    @MainActor private func enablePanToClose() {
        let pan = UIPanGestureRecognizer(target: self, action: #selector(toastOnPan(_:)))
        self.view.addGestureRecognizer(pan)
    }
    
    @MainActor @objc private func toastOnPan(_ gesture: UIPanGestureRecognizer) {
